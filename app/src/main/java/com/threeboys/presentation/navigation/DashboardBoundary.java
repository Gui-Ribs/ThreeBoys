...
public class DashboardBoundary {
    ...
    private void show() {
        Label titulo = new Label("Three Boys — Main");
        ...
        shortcuts.getChildren().addAll(
                shortcut("Clientes", scenes::clientes),
                shortcut("Pedidos", scenes::pedidos),
                shortcut("Produto", scenes::produto),
                shortcut("Material", scenes::material));

        root.setPadding(new Insets(24));
        root.setAlignment(Pos.TOP_CENTER);
        VBox.setMargin(shortcuts, new Insets(120));
        root.getChildren().addAll(titulo, shortcuts);
    }
